...
import mx.edu.utez.scimec.config.filter.JwtAuthenticationEntryPoint;
import mx.edu.utez.scimec.config.filter.JwtAuthenticationFilter;
import mx.edu.utez.scimec.config.filter.JwtAuthorizationFilter;
import mx.edu.utez.scimec.util.JwtTokenUtil;
import mx.edu.utez.scimec.service.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors()//añade los permisos para cors
                ...
                .antMatchers("/doctor/**").hasAuthority("Worker")
